...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_REP_GET_BY_PROGRESS,
            query = JpaConst.Q_REP_GET_BY_PROGRESS_DEF),
    @NamedQuery(
            name = JpaConst.Q_REP_COUNT_RESISTERED_BY_PROGRESS,
            query = JpaConst.Q_REP_COUNT_RESISTERED_BY_PROGRESS_DEF)
})
